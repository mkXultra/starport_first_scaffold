...
export const protobufPackage = "mkXultra.starportfirstscaffold.starportfirstscaffold";
...
export class MsgClientImpl {
    ...
    CreatePost(request) {
        ...
        const promise = this.rpc.request("mkXultra.starportfirstscaffold.starportfirstscaffold.Msg", "CreatePost", data);
